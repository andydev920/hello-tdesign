              ...
              children: [
                {
                  ...
                  meta: {
                    ...
                    subtitle: {
                      zh_CN: '这是一个财务管理页面的示例',
                      en_US: 'This is an example of a finance management page',
                      ja_JP: 'これは財務管理ページの例です',
                    },
                  },
                },
              ],
              ...
              children: [
                {
                  ...
                  meta: {
                    ...
                    subtitle: {
                      zh_CN: '这是一个基础列表页面的示例',
                      en_US: 'This is an example of a base list page',
                      ja_JP: 'これは基本リストページの例です',
                    },
                  },
                },
                {
                  ...
                  meta: {
                    ...
                    subtitle: {
                      zh_CN: '这是一个卡片列表页面的示例',
                      en_US: 'This is an example of a card list page',
                      ja_JP: 'これはカードリストページの例です',
                    },
                  },
                },
                {
                  ...
                  meta: {
                    ...
                    subtitle: {
                      zh_CN: '这是一个筛选列表页面的示例',
                      en_US: 'This is an example of a filter list page',
                      ja_JP: 'これはフィルターリストページの例です',
                    },
                  },
                },
                {
                  ...
                  meta: {
                    ...
                    subtitle: {
                      zh_CN: '这是一个树状筛选列表页面的示例',
                      en_US: 'This is an example of a tree filter list page',
                      ja_JP: 'これはツリーフィルターリストページの例です',
                    },
                  },
                },
              ],
